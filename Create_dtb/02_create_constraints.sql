...
-- card_device_access
ALTER TABLE card_device_access
    ADD CONSTRAINT fk_card_device_access_card
        FOREIGN KEY (access_card_id) REFERENCES access_cards(id)
        ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE card_device_access
    ADD CONSTRAINT fk_card_device_access_device
        FOREIGN KEY (device_id) REFERENCES devices(id)
        ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE card_device_access
    ADD CONSTRAINT fk_card_device_access_granted_by
...
CREATE INDEX idx_card_device_access_card ON card_device_access(access_card_id);
CREATE INDEX idx_card_device_access_device ON card_device_access(device_id);
CREATE INDEX idx_card_device_access_status ON card_device_access(status);
CREATE INDEX idx_card_device_access_expires ON card_device_access(expires_at);
